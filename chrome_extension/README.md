...
this directory stays a prototype component. This status does not apply to the
`openadapt-capture` package. The package is the Beta canonical native recorder.
