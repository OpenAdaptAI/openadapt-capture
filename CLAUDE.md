...
**openadapt-capture** is the Beta canonical native recorder for OpenAdapt. It
captures platform-native GUI interaction streams with time-aligned media for
`openadapt-flow` and OpenAdapt Desktop.
