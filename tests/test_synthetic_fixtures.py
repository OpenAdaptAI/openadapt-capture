...
def _builder_reproduces_the_committed_fixtures() -> bool:
    import sqlalchemy
...
@pytest.mark.skipif(
    not _builder_reproduces_the_committed_fixtures(),
    reason="this builder cannot reproduce the committed fixture bytes",
)
